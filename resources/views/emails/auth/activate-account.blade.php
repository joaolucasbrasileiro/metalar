                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%; border-collapse:collapse;">
                                ...
                                <tr>
                                    <td style="padding:12px 36px 30px 36px;">
                                        <a href="{{ $activationUrl }}" style="display:inline-block; background:#ffd900; color:#18181b; border-radius:6px; padding:14px 22px; font-size:14px; line-height:18px; font-weight:800; text-decoration:none;">
                                            Ativar conta
                                        </a>
                                    </td>
                                </tr>
