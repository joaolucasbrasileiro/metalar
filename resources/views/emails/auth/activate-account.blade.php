...
<head>
    ...
    <title>Ative sua conta na Metalar</title>
</head>
<body style="margin:0; padding:0; background:#f4f4f5; color:#18181b; font-family:Arial, Helvetica, sans-serif;">
    <span style="display:none; max-height:0; overflow:hidden; opacity:0;">
        Ative sua conta para liberar seu acesso a Metalar.
    </span>
                                ...
                                <tr>
                                    <td style="padding:0 36px 4px 36px;">
                                        ...
                                        <p style="margin:0 0 18px 0; color:#52525b; font-size:15px; line-height:25px;">
                                            Sua conta foi criada com sucesso. Clique no botao abaixo para confirmar seu email e liberar o acesso.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:12px 36px 30px 36px;">
                                        <a href="{{ $activationUrl }}" style="display:inline-block; background:#18181b; color:#ffffff; border-radius:6px; padding:14px 22px; font-size:14px; line-height:18px; font-weight:800; text-decoration:none;">
                                            Ativar conta
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:0 36px 34px 36px;">
                                        <p style="margin:0 0 12px 0; color:#71717a; font-size:13px; line-height:22px;">
                                            Este link expira em 60 minutos. Se voce nao criou essa conta, ignore este email.
                                        </p>
